...
if (!isset($_SESSION['role']) || $_SESSION['role'] != 'employee') {
    // Redirect to login if the user is not a regular user
...
.logout {
 ...
 /* Custom Styles for the Ikmal Button */
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <p>Welcome, <strong><?php echo $_SESSION['username']; ?></strong>! You can manage the inventory using the link above or by button on table.</p>
        </div>
